...
export const rolePermissionMatrix: Record<UserRole, RolePermissionConfig> = {
  root: {
    ...
    modules: {
      ...
      operators: createModuleAccess(true, managementActions),
  ...
  admin: {
    ...
    modules: {
      ...
      operators: createModuleAccess(true, ["view", "create", "edit", "delete"]),
  ...
  noc: {
    ...
    modules: {
      ...
      operators: createModuleAccess(true, ["view"]),
  ...
  csr: {
    ...
    modules: {
      ...
      operators: createModuleAccess(true, viewOnlyActions, true),
